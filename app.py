...
st.markdown("<br><hr><center>Made  by <a href='mailto:sarankumar131313@gmail.com?subject=ToDo WebApp!&body=Please specify the issue you are facing with the app.'><strong>Saran Kumar</strong></a></center><hr>", unsafe_allow_html=True)
